    ...
    try:
        ...
        with tab1:
            ...
            if CO2_df is not None:
                ...
                if is_charging:
                    st.success(f"Should charge laptop. Current CO2 intensity: {current_emission:.2f} gCO2eq/kWh (Below Threshold)")
                else:
                    st.error(f"Laptop is NOT charging. Current CO2 intensity: {current_emission:.2f} gCO2eq/kWh (Above Threshold)")
